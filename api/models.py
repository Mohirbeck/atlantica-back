...
class ProjectModel(models.Model):
    ...
    client = models.CharField(
        max_length=255, verbose_name="Клиент", blank=True, null=True
    )
    ...
    status = models.CharField(
        max_length=255, choices=statuses, verbose_name="Статус", blank=True, null=True
    )
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Дата обновления")
    is_active = models.BooleanField(default=True, verbose_name="Активность")
...
class BannerModel(models.Model):
    link = models.CharField(
        max_length=255, verbose_name="Ссылка", blank=True, null=True
    )
...
class PartnerModel(models.Model):
    name = models.CharField(
        max_length=255, verbose_name="Название партнера", blank=True, null=True
    )
...
class FooterModel(models.Model):
    ...
    linkedin = models.CharField(
        max_length=255, verbose_name="Ссылка на linkedin", blank=True, null=True
    )
    facebook = models.CharField(
        max_length=255, verbose_name="Ссылка на facebook", blank=True, null=True
    )
    twitter = models.CharField(
        max_length=255, verbose_name="Ссылка на twitter", blank=True, null=True
    )
